...
import co.id.fikridzakwan.data.source.paging.MoreMoviePagingSource
import co.id.fikridzakwan.data.source.paging.SearchMoviePagingSource
import co.id.fikridzakwan.data.source.response.DetailResponse
import co.id.fikridzakwan.data.source.response.ResultsItem
import co.id.fikridzakwan.data.source.room.MovieDao
...
class MovieRepository(private val movieApi: MovieApi, private val movieDb: MovieDao) :
    IMovieRepository {
